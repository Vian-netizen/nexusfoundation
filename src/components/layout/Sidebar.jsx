  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <motion.div
              ...
              className="min-w-0"
            >
              <h1 className="text-sm font-bold font-mono tracking-wider text-foreground truncate">
                SCP FOUNDATION
              </h1>
      ...
      <nav className="flex-1 py-3 px-2 space-y-0.5 overflow-y-auto">
        <p
          className={`text-[10px] font-mono text-muted-foreground tracking-widest px-3 py-2 ${
